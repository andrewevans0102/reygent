...
/**
 * Detect whether a comment was generated by reygent itself.
 * Reygent's own PR review comments naturally mention security-related terms,
 * so they must skip security classification to avoid false positives.
 */
function isReygentComment(comment: ReviewComment): boolean {
  return (
    comment.body.includes("🐱 Reygent PR Review") ||
    comment.body.includes("*Review by [reygent]")
  );
}
